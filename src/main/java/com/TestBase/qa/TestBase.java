...
public class TestBase {
	...
	public static void initil() {
		...
		driver.manage().timeouts().pageLoadTimeout(com.TestUtil.qa.TestUtil.PAGELOADOUTTIME, TimeUnit.SECONDS);
		driver.manage().timeouts().implicitlyWait(com.TestUtil.qa.TestUtil.IMPLICITYWAIT, TimeUnit.SECONDS);
